...
[🌐 갈피 서비스 바로가기](https://tgthon-aldama.netlify.app)
...
| **백엔드·DB** | `Next.js Server Actions` · `Supabase Auth` · `PostgreSQL` · `Row Level Security` |
| **AI 분석** | `Google Gemini Flash Lite` · 정규식 기반 기본 분석기 |
| **외부 연동** | `LearningX Canvas API` |
| **알림** | `Service Worker` · `Web Push` · `VAPID` |
| **배포** | `Netlify` · `Supabase Cloud` |
| **검증** | `Vitest` · `ESLint` · `TypeScript` |
